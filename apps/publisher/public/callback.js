...
var Callback = () => {
  (0, import_react.useEffect)(() => {
    ...
    window.electronAPI.exchangeAuthCode(code, verifier).then(() => {
      window.close();
    }).catch(() => {
      window.location.href = "/";
    });
  }, []);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: 20, fontFamily: "sans-serif" }, children: "Processing authentication\u2026" });
};
var container = document.getElementById("root");
(0, import_client.createRoot)(container).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Callback, {}));
